...
function display(){
	...
	var rope1=this.rope.bob1.body.position;
	var rope2=this.rope.bob2.position;
	var rope3=this.rope.bob3.position;
	var rope4=this.rope.bob4.position;
	var rope5=this.rope.bob5.position;
